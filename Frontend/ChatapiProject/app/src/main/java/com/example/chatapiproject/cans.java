...
public class cans extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textreply = findViewById(R.id.tcans);
        textlinks = findViewById(R.id.tcansl);
        textreply.setText(reply0);
        textlinks.setText(links);
        /*String reply1 = reply0.replace("\\n", "\n");
        textView.setText("\n" + reply1);*/
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        home.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem menuItem) {
                Intent i = new Intent(cans.this, microphone.class);
                startActivity(i);
                return false;
            }
        });
        ...
        pdf.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(cans.this);
                builder.setTitle("Enter File Name");

                // Set up the input
                final EditText input = new EditText(cans.this);
